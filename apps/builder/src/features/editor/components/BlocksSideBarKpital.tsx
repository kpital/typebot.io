...
export const BlocksSideBar = () => {
  ...
  const filteredForgedBlockIds = Object.values(forgedBlocksVisible)
    .filter((block) => {
      return (
  ...
  const filteredBubbleBlockTypes = Object.values(BubbleBlockTypeVisible).filter(
    (type) =>
  ...
  const filteredInputBlockTypes = Object.values(InputBlockTypeVisible).filter(
    (type) =>
  ...
  const filteredLogicBlockTypes = Object.values(LogicBlockTypeVisible)
    .filter((type) =>
